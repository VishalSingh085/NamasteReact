...
//         React.createElement("h1",{}," h2  dfgkkn nndnn "),
//     ]),
//     React.createElement("div",{id:"child2"},[
//         React.createElement("h1",{}," h3 tag"),
//         React.createElement("h1",{},"h4 tag"),
//     ]),
// ]);

//JSX - bael tranpiles  into React.component - reactElement-js object => htmlelement(render)
// const Head =  ()=> {
//     return <h3 >Namste lecture 3</h3>
// }
// const number = 10000;
// const JsxHeading=() => (
//     <div id="container">
...
// <Head></Head>
// {number}
// <h1 className="head">namaste react
//                 using jsx 
//                 </h1>
//                 </div>
//  );
 ...
 *   -RestaurantCard
 *      - image
 *      - Name ,star rating ,cuisine , delevery tie
 *   -copyright 
 *   -Links
 *   -Address
 *   -Contact
...
//inside direct write also  ====> style={{backgroundColor:"yellowgreen"}}
// }

const RestaurantCard = (props)=>{
    const {resData} =props;
    const {cloudinaryImageId, name , cuisines,costForTwo,deliveryTime ,avgRating} = resData?.data;
      return (
        <div className="res-card">
        <img className="food-logo" alt="res-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" +cloudinaryImageId }/>
            <h1>{name}</h1>
            <h4>{cuisines.join(", ")}</h4>
            <h4 style={{textAlign:"center"}} >{avgRating} stars</h4>
            <h4 style={{textAlign:"center"}}>₹{costForTwo/100} FOR TWO</h4>
            <h4 style={{textAlign:"center"}}>{deliveryTime}minutes</h4>
        </div>
      );
};

//in map method not recommoned in react to use indexes .. 
const Body = () =>{
    return (
    <div className="body">
        <div className="search"><input type="search"></input></div>
